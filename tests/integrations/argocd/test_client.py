...
from integrations.argocd.client import ArgoCDClient, ArgoCDConfig, make_argocd_client
...
def test_verify_ssl_false_is_passed_to_http_client(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("integrations.argocd.client.httpx.Client", FakeClient)
    client = ArgoCDClient(
        ArgoCDConfig(
            base_url="https://argocd.example.com",
            bearer_token="tok_test",
